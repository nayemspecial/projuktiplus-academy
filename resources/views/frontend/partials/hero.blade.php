        ...
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div class="lg:w-1/2 text-center lg:text-left relative">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-10">
                    <button onclick="document.getElementById('learning-path').scrollIntoView({ behavior: 'smooth' })" 
            ...
            <div class="lg:w-1/2 relative">
                ...
                <div class="absolute -bottom-6 left-6 bg-white/80 dark:bg-slate-800/90 backdrop-blur-md p-4 rounded-xl shadow-xl border border-white/20 dark:border-slate-700 flex items-center gap-4 animate-float-delay z-20 min-w-[180px]">
                    ...
                    <div>
                        <p class="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">ফ্রন্টএন্ড ফ্রেমওয়ার্ক</p>
                        <p class="text-xl font-bold text-slate-900 dark:text-white">Vue.js 3</p>
                    </div>
                </div>
                ...
                <div class="absolute -top-6 right-6 md:-right-6 bg-white/80 dark:bg-slate-800/90 backdrop-blur-md p-4 rounded-xl shadow-xl border border-white/20 dark:border-slate-700 flex items-center gap-4 animate-float-delay z-20 min-w-[180px]">
                    ...
                    <div>
                        <p class="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase">ব্যাকেন্ড ফ্রেমওয়ার্ক</p>
                        <p class="text-xl font-bold text-slate-900 dark:text-white">Laravel 12</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="hidden lg:block absolute right-10 bottom-10 z-50 w-80 animate-bounce-in">
         <div class="bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-2xl hover:shadow-primary-500/10 transition-all duration-300 border-t-4 border-t-primary-500 relative overflow-hidden group">
            ...
            <h3 class="text-base font-bold text-slate-900 dark:text-white mb-4 flex items-center justify-between border-b border-slate-200 dark:border-slate-700 pb-3">
                <span class="flex items-center gap-2"><i class="far fa-calendar-alt text-primary-500"></i> সময়সূচি</span>
