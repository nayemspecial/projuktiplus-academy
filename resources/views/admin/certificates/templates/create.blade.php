...
@section('title', 'নতুন টেমপ্লেট তৈরি করুন - ProjuktiPlus LMS Admin')
...
<div class="mx-auto max-w-4xl">
    <div class="bg-white dark:bg-slate-800 rounded-lg shadow overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-700">
            <h3 class="text-lg font-medium text-gray-800 dark:text-white">নতুন সার্টিফিকেট টেমপ্লেট তৈরি করুন</h3>
        </div>
        
        <form action="{{ route('admin.certificates.templates.store') }}" method="POST">
            @csrf
