<section class="py-16 md:py-24 bg-white dark:bg-slate-900 transition-colors duration-300 relative overflow-hidden">
    
    <div class="absolute bottom-0 right-0 -mr-20 -mb-20 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl pointer-events-none"></div>
    <div class="absolute top-0 left-0 -ml-20 -mt-20 w-80 h-80 bg-purple-500/10 rounded-full blur-3xl pointer-events-none"></div>
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="text-center max-w-3xl mx-auto mb-12">
            <h2 class="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white mb-3 font-heading">
                <span class="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 dark:from-gray-100 via-purple-600 dark:via-purple-300 to-pink-600 dark:to-pink-200">
                    কেন এই জার্নিটি আপনার জন্য?
                </span>
            </h2>
            <p class="text-sm md:text-base text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
                গতানুগতিক ভিডিও কোর্সের মতো আমরা আপনাকে একা ছেড়ে দিই না। আমাদের স্ট্রাকচার্ড লার্নিং পাথ এবং মেন্টরশিপ আপনাকে লক্ষ্যে পৌঁছাতে সাহায্য করবে।
            </p>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            ...
            <div class="group bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-3 md:p-5 border border-slate-200 dark:border-slate-700 hover:border-blue-500/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 text-center">
                ...
                <h3 class="text-base md:text-lg font-bold text-slate-900 dark:text-white mb-2 font-heading">লাইভ মেন্টরশিপ</h3>
                <p class="text-xs md:text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                    আপনার প্রতিটি প্রশ্নের উত্তর দিতে এবং কনফিউশন দূর করতে আমরা লাইভ সেশনের পর প্রশ্ন-উত্তর পর্বের আয়োজন করি।
                </p>
            </div>
            ...
            <div class="group bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-3 md:p-5 border border-slate-200 dark:border-slate-700 hover:border-purple-500/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 text-center">
                ...
                <h3 class="text-base md:text-lg font-bold text-slate-900 dark:text-white mb-2 font-heading">প্রজেক্ট ভিত্তিক লার্নিং</h3>
                <p class="text-xs md:text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                    প্রজেক্ট ভিত্তিক লার্নিং সবাই খুব সহজে বুঝতে পারে। তাই আমরা প্রজেক্ট করতে করতে থিওরি শিখবো। আনন্দের সাথে শিখতে পারবেন।
                </p>
            </div>
            ...
            <div class="group bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-3 md:p-5 border border-slate-200 dark:border-slate-700 hover:border-red-500/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 text-center">
                ...
                <h3 class="text-base md:text-lg font-bold text-slate-900 dark:text-white mb-2 font-heading">আপ-টু-ডেট সিলেবাস</h3>
                <p class="text-xs md:text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                    টেকনোলজি প্রতিনিয়ত বদলায়। আমরা শিখব ২০২৬ সালের ইন্ডাস্ট্রির চাহিদা অনুযায়ী Laravel 12 এবং Vue 3।
                </p>
            </div>
            ...
            <div class="group bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-3 md:p-5 border border-slate-200 dark:border-slate-700 hover:border-indigo-500/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 text-center">
                ...
                <h3 class="text-base md:text-lg font-bold text-slate-900 dark:text-white mb-2 font-heading">ডেডিকেটেড সাপোর্ট</h3>
                <p class="text-xs md:text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                    একা একা শেখা কঠিন হতে পারে, কিন্তু আমাদের কমিউনিটি ও সাপোর্টের সাথে শেখাটা হবে আনন্দদায়ক।
                </p>
            </div>
            ...
            <div class="group bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-3 md:p-5 border border-slate-200 dark:border-slate-700 hover:border-emerald-500/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 text-center">
                ...
                <h3 class="text-base md:text-lg font-bold text-slate-900 dark:text-white mb-2 font-heading">ক্যারিয়ার গাইডলাইন</h3>
                <p class="text-xs md:text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                    নিজেকে কীভাবে প্রেজেন্ট করবেন, সিভি তৈরি, পোর্টফোলিও, গিতহাব এবং ইন্টারভিউ হ্যাকস নিয়ে থাকবে বিশেষ সেশন।
                </p>
            </div>
            ...
            <div class="group bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-3 md:p-5 border border-slate-200 dark:border-slate-700 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 text-center">
                ...
                <h3 class="text-base md:text-lg font-bold text-slate-900 dark:text-white mb-2 font-heading">ফিক্সড রুটিন</h3>
                <p class="text-xs md:text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                    আমাদের ফিক্সড ক্লাস শিডিউল আপনাকে একটি ডিসিপ্লিনের মধ্যে রাখবে। অলসতা কাটিয়ে আপনাকে নিয়মিত হতে সাহায্য করবে।
                </p>
            </div>
            ...
            <div class="group bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-3 md:p-5 border border-slate-200 dark:border-slate-700 hover:border-pink-500/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 text-center">
                ...
                <h3 class="text-base md:text-lg font-bold text-slate-900 dark:text-white mb-2 font-heading">ব্যাচ ওয়াইজ লার্নিং</h3>
                <p class="text-xs md:text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                    একা দৌড়ানোর চেয়ে সবার সাথে দৌড়ানো সহজ। ব্যাচের অন্য স্টুডেন্টদের অগ্রগতি দেখে আপনিও এগিয়ে যাওয়ার উৎসাহ পাবেন।
                </p>
            </div>
            ...
            <div class="group bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-3 md:p-5 border border-slate-200 dark:border-slate-700 hover:border-orange-500/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 text-center">
                ...
                <h3 class="text-base md:text-lg font-bold text-slate-900 dark:text-white mb-2 font-heading">ডেডলাইন ও চ্যালেঞ্জ</h3>
                <p class="text-xs md:text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                    সময়ের কাজ সময়ে করার অভ্যাস গড়তে আমাদের টাস্কগুলো এবং ডেডলাইন আপনাকে দারুণভাবে সাহায্য করবে।
                </p>
            </div>
